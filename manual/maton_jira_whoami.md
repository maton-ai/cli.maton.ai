...
{% raw %}## maton jira whoami

```
maton jira whoami [flags]
```

Calls /myself on the given cloud and prints the authenticated account. Use 'maton jira cloud list' to discover the cloud ID.
