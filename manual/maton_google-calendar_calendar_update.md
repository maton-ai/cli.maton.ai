...
{% raw %}## maton google-calendar calendar update

Update a calendar's metadata

```
maton google-calendar calendar update <calendar-id> [flags]
```
...
{% highlight bash %}{% raw %}
$ maton google-calendar calendar update <id> --summary 'New title'
{% endraw %}{% endhighlight %}
