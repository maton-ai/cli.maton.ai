...
{% raw %}## maton outlook message draft

Create a draft message

```
maton outlook message draft [flags]
```
...
{% highlight bash %}{% raw %}
$ maton outlook message draft --to alice@example.com --subject "Hi" --body "hello"
$ maton outlook message draft --to a@b.com --subject Report --body "<p>...</p>" --html
{% endraw %}{% endhighlight %}
