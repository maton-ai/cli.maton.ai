...
{% raw %}## maton github repo credits

List contributors to a repository

```
maton github repo credits [flags]
```
...
{% highlight bash %}{% raw %}
$ maton github repo credits --repo maton-ai/cli
$ maton github repo credits --repo maton-ai/cli --paginate --format text
{% endraw %}{% endhighlight %}
