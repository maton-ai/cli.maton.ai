...
{% raw %}## maton github issue edit

Edit an issue's fields

```
maton github issue edit <number-or-url> [flags]
```
...
<dl class="flags">
	...
	<dd>Milestone number; pass &#39;none&#39; to clear</dd>
...
{% highlight bash %}{% raw %}
$ maton github issue edit 123 --repo maton-ai/cli --title "New title"
$ maton github issue edit 123 --repo maton-ai/cli --add-label needs-review --remove-label triage
$ maton github issue edit https://github.com/maton-ai/cli/issues/123 --add-assignee @me
{% endraw %}{% endhighlight %}
