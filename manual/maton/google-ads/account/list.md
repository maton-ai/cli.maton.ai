...
{% raw %}## maton google-ads account list

List all accessible customer accounts

```
maton google-ads account list [flags]
```
...
### ALIASES
 ...
 maton google-ads accounts ls,  maton google-ads customer ls,  maton google-ads customers ls, maton google-ads account ls
