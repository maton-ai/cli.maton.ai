...
{% raw %}## maton google-ads account view

Get account details for a customer ID

```
maton google-ads account view <customer-id> [flags]
```
...
{% highlight bash %}{% raw %}
$ maton google-ads account view 1234567890
$ maton google-ads account view 123-456-7890
{% endraw %}{% endhighlight %}
