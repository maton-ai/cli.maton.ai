...
{% raw %}## maton google-ads ad list

List ads (excludes removed)

```
maton google-ads ad list [flags]
```
...
<dl class="flags">
	<dt>
		<code>--ad-group-id &lt;string&gt;</code></dt>
	<dd>Filter by ad group ID</dd>
...
### ALIASES
 ...
 maton google-ads ads ls, maton google-ads ad ls
