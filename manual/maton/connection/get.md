...
{% raw %}## maton connection get

```
maton connection get <id> [flags]
```
...
{% highlight bash %}{% raw %}
$ maton connection get conn_abc123
$ maton connection get conn_abc123 --json status,url
$ maton connection get conn_abc123 --json metadata --jq '.metadata.team'
{% endraw %}{% endhighlight %}
