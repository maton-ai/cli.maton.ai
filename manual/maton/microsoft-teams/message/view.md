...
{% raw %}## maton microsoft-teams message view

Show a single message

```
maton microsoft-teams message view <message-id> [flags]
```
...
{% highlight bash %}{% raw %}
$ maton microsoft-teams message view 1700000000000 --team 19:t... --channel 19:c...
