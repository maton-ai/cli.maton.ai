...
{% raw %}## maton hubspot deal batch-create

```
maton hubspot deal batch-create [flags]
```
...
{% highlight bash %}{% raw %}
$ maton hubspot deal batch-create --data '[{"properties":{"dealname":"A","amount":"100"}},{"properties":{"dealname":"B"}}]'
{% endraw %}{% endhighlight %}
