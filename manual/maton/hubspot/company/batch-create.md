...
{% raw %}## maton hubspot company batch-create

```
maton hubspot company batch-create [flags]
```
...
{% highlight bash %}{% raw %}
$ maton hubspot company batch-create --data '[{"properties":{"name":"Acme","domain":"acme.com"}}]'
{% endraw %}{% endhighlight %}
