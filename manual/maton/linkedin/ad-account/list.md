...
{% raw %}## maton linkedin ad-account list

List advertising accounts you have access to

```
maton linkedin ad-account list [flags]
```
...
$ maton linkedin ad-account list --limit 50 --paginate
{% endraw %}{% endhighlight %}
