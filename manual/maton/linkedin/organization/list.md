...
{% raw %}## maton linkedin organization list

List organizations where you have admin/posting roles

```
maton linkedin organization list [flags]
```
...
$ maton linkedin organization list --limit 50 --paginate
{% endraw %}{% endhighlight %}
