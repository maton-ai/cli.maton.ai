...
{% raw %}## maton slack message replies

Get replies in a message thread

```
maton slack message replies [flags]
```
...
<dl class="flags">
	...
	<dd>Parent message timestamp (required)</dd>
</dl>
...
{% highlight bash %}{% raw %}
$ maton slack message replies --channel C012 --ts 1700000000.000100
$ maton slack message replies --channel C012 --ts 1700000000.000100 --limit 100
{% endraw %}{% endhighlight %}
