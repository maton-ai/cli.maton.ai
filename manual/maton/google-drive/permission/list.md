...
{% raw %}## maton google-drive permission list

List permissions on a file or folder

```
maton google-drive permission list [flags]
```
...
<dl class="flags">
	...
	<dd>Max permissions per page (1-100)</dd>
...
$ maton google-drive permission list -f 1aBcD... --paginate
{% endraw %}{% endhighlight %}
