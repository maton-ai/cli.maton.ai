...
{% raw %}## maton google-drive permission update

Change a permission's role

```
maton google-drive permission update <permission-id> [flags]
```
...
<dl class="flags">
	...
	<dd>Required when changing to --role=owner</dd>
</dl>
