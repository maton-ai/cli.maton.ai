...
{% raw %}## maton google-drive permission get

Show a single permission

```
maton google-drive permission get <permission-id> [flags]
```
...
### ALIASES
 ...
 maton google-drive permissions view, maton google-drive permission view
