...
{% raw %}## maton google-drive revision get

Show revision metadata

```
maton google-drive revision get <revision-id> [flags]
```
...
### ALIASES
 ...
 maton google-drive revisions view, maton google-drive revision view
