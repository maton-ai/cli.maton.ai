...
{% raw %}## maton salesforce record view

Get a record by ID

```
maton salesforce record view <id> [flags]
```
...
$ maton salesforce record view 0035g00000XYZ --type Contact --fields Id,FirstName,Email
{% endraw %}{% endhighlight %}
