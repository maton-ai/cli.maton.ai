...
{% raw %}## maton google-mail label create

Create a new label

```
maton google-mail label create [flags]
```
...
<dl class="flags">
	...
	<dd>labelShow, labelShowIfUnread, labelHide</dd>
...
$ maton google-mail label create --name 'Hidden' --label-list-visibility labelHide
{% endraw %}{% endhighlight %}
