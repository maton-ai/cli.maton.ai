...
{% raw %}## maton stripe coupon list

List coupons

```
maton stripe coupon list [flags]
```
...
<dl class="flags">
	...
	<dd>Cursor for previous page (coupon ID)</dd>
	...
	<dd>Cursor for next page (coupon ID)</dd>
...
$ maton stripe coupon list -L 50 --paginate
{% endraw %}{% endhighlight %}
