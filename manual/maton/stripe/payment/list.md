...
{% raw %}## maton stripe payment list

List payment intents

```
maton stripe payment list [flags]
```
...
<dl class="flags">
	...
	<dd>Cursor for next page (payment intent ID)</dd>
...
$ maton stripe payment list --customer cus_123 -L 25
$ maton stripe payment list --paginate
{% endraw %}{% endhighlight %}
