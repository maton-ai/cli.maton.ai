...
{% raw %}## maton jira transition apply

```
maton jira transition apply <issue-key> [flags]
```

Apply a workflow transition by id. Use 'maton jira transition list <issueKey>' to discover valid transition ids.
...
<dl class="flags">
	...
	<dd>Transition ID (required; from &#39;transition list&#39;)</dd>
