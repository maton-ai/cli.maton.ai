...
{% raw %}## maton jira issue get

Get an issue by key (e.g. PROJ-123)

```
maton jira issue get <issue-key> [flags]
```
...
### ALIASES
 ...
 maton jira issues view, maton jira issue view

{% endraw %}
### Examples

{% highlight bash %}{% raw %}
$ maton jira issue get PROJ-123 --cloud-id abc-123
{% endraw %}{% endhighlight %}
