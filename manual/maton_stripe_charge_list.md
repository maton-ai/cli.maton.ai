...
{% raw %}## maton stripe charge list

List charges

```
maton stripe charge list [flags]
```
...
<dl class="flags">
	...
	<dd>Cursor for next page (charge ID)</dd>
...
$ maton stripe charge list --customer cus_123 -L 25
$ maton stripe charge list --paginate
{% endraw %}{% endhighlight %}
