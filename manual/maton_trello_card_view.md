...
{% raw %}## maton trello card view

Get a card by ID

```
maton trello card view <id> [flags]
```
...
{% highlight bash %}{% raw %}
$ maton trello card view 5f1a2b3c4d5e6f7a8b9c0d1e
$ maton trello card view 5f1a... --members --checklists all
{% endraw %}{% endhighlight %}
