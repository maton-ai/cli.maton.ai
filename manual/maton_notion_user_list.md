...
{% raw %}## maton notion user list

List workspace users (people and bots)

```
maton notion user list [flags]
```
...
$ maton notion user list --paginate
$ maton notion user list --format text
{% endraw %}{% endhighlight %}
